                        ...
                        if(task.isSuccessful()){
                            ...
                            fuser.sendEmailVerification().addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    Toast.makeText(com.example.cakebuzz_cakeorderingapp.Register.this, "Verification Email Has been Sent.", Toast.LENGTH_SHORT).show();
                                }
                            ...
                            Toast.makeText(com.example.cakebuzz_cakeorderingapp.Register.this, "User Created.", Toast.LENGTH_SHORT).show();
